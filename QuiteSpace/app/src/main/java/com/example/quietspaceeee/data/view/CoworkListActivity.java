...
public class CoworkListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Cafe> bibliotheques = new ArrayList<>();
        for (Cafe cafe : fullCafeList) {
            if ("Espace Coworking".equalsIgnoreCase(cafe.getType())) {
                bibliotheques.add(cafe);
            }
        }
        fullCafeList =bibliotheques;
        ...
        cafeListView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(CoworkListActivity.this, CafeDetailActivity.class);
    ...
    private void reloadCafeList() {
        CafeRepository repository = new CafeRepository(this);
        ArrayList<Cafe> allCafes = repository.getAllCafes();

        fullCafeList.clear();
        for (Cafe cafe : allCafes) {
            if ("Espace Coworking".equalsIgnoreCase(cafe.getType())) {
                fullCafeList.add(cafe);
            }
        }
