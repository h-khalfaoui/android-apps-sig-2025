...
public class BibListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (Cafe cafe : fullCafeList) {
            if ("Bibliothèque".equalsIgnoreCase(cafe.getType())) {
        ...
        cafeListView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(BibListActivity.this, CafeDetailActivity.class);
